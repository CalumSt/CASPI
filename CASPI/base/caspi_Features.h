...
#  if __has_cpp_attribute(clang::nonblocking) && defined(CASPI_COMPILER_CLANG) && !defined(CASPI_PLATFORM_MACOS)
...
// blocking
#if defined(__has_cpp_attribute)
#  if __has_cpp_attribute(clang::blocking) && defined(CASPI_COMPILER_CLANG) && !defined(CASPI_PLATFORM_MACOS)
...
// Non-allocating
#if defined(__has_cpp_attribute)
#  if __has_cpp_attribute(clang::nonallocating)  && defined(CASPI_COMPILER_CLANG) && !defined(CASPI_PLATFORM_MACOS)
...
// allocating
#if defined(__has_cpp_attribute)
#  if __has_cpp_attribute(clang::allocating)  && defined(CASPI_COMPILER_CLANG) && !defined(CASPI_PLATFORM_MACOS)
